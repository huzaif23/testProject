...
public class UpdateFCMToken extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Account/UpdateFCMToken");

            //  URL url = new URL("http://123ngo.somee.com/api/Account/ChangePassword");

            String FCMDeviceToken=strings[0];

            JSONObject postDataParams = new JSONObject();
            postDataParams.put("FCMDeviceToken", FCMDeviceToken);
            postDataParams.put("AccessToken", Signin.access_token);
