...
public class NotifyUserDriverReached extends AsyncTask<String, Void, String> {
    String Error_Message="";
    DriverRoute driverRoute;
    public NotifyUserDriverReached(DriverRoute driverRoute){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Booking/NotifyUserDriverReached");
