...
public class ForgetChangePasswordPostRequest extends AsyncTask<String, Void, String> {
    ForgetChangePassword forgetChangePassword;
    String Error_Message="";
    public ForgetChangePasswordPostRequest(ForgetChangePassword forgetChangePassword){
        this.forgetChangePassword=forgetChangePassword;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            ...
            String OldPassword=forgetChangePassword.oldpassword;
    ...
    protected void onPostExecute(String result) {
        ...
        if (Error_Message != "") {
            forgetChangePassword.showresponse(Error_Message);
            Error_Message="";
        }
       else {

            forgetChangePassword.passwordchanged();
            forgetChangePassword.showresponse("Password Changed");
        }
    }
