...
public class UserBookingHistory extends AsyncTask<String, Void, String> {
    String Error_Message="";
    HomeMain homeMain;
    public  UserBookingHistory(HomeMain homeMain){
    ...
    protected String doInBackground(String... strings) {
        try{
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Booking/UserBookingHistory");
...
*/
            ...
            try {
                ...
                for (int i = 0; i < user.length(); i++)
                {
                    ...
                    homeMain.booking_date.add(user.getJSONObject(i).getString("booking_date"));
                    homeMain.booking_status_id.add(user.getJSONObject(i).getString("booking_status_id"));
                    homeMain.amount.add(user.getJSONObject(i).getString("amount"));
                    homeMain.pickup_latitude.add(user.getJSONObject(i).getString("pickup_latitude"));
                    homeMain.pickup_longitude.add(user.getJSONObject(i).getString("pickup_longitude"));
                    homeMain.dropoff_latitude.add(user.getJSONObject(i).getString("dropoff_latitude"));
                    homeMain.dropoff_longitude.add(user.getJSONObject(i).getString("dropoff_longitude"));
