...
public class UpdateUserName extends AsyncTask<String, Void, String> {
    ChangeUserName changeUserName;
    String Error_Message="";
   static String FirstName;
    public UpdateUserName(ChangeUserName changeUserName){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Account/UpdateUserName");
            ...
            if (responseCode == HttpsURLConnection.HTTP_OK) {
                ...
                BufferedReader in=new BufferedReader(
                        new InputStreamReader(
                                conn.getInputStream()));
                String line="";
                changeUserName.usernamechanged();
    ...
    protected void onPostExecute(String result) {
        ...
        if (Error_Message != "") {
            changeUserName.showresponse(Error_Message);
            Error_Message="";
        }else {
        changeUserName.usernamechanged();
        Signin.userName=FirstName;
    }}
