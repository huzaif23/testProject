...
public class BookingCancelFromPassenger extends AsyncTask<String, Void, String> {
    TripConfirmed tripConfirmed;
    String Error_Message="";
    public BookingCancelFromPassenger(TripConfirmed tripConfirmed){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Booking/BookingCancelFromPassenger");
...
if(Error_Message==null){
    Error_Message="";
        ...
        if (Error_Message != "") {
            tripConfirmed.showresponse(Error_Message);
            Error_Message="";
        } else {
            ...
            try {
                ...
                if (Error_Message.isEmpty() || Error_Message.toString() == "") {
                    ...
                    tripConfirmed.showresponse(messages);
