...
public class GoForPickup extends AsyncTask<String, Void, String> {
    DriverRoute driverRoute;
    String Error_Message="";
   static String booking_detail_id;
    public GoForPickup(DriverRoute driverRoute){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Booking/GoForPickup");
            booking_detail_id=strings[0];
