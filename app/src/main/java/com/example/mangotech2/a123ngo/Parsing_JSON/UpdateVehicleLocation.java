...
public class UpdateVehicleLocation extends AsyncTask<String, Void, String> {
    HomeMain homeMain;
    String Error_Message="";
   static String current_location_latitude,current_location_longitude;
    public UpdateVehicleLocation(HomeMain homeMain){
    ...
    protected String doInBackground(String... strings) {
     ...
     if(isconnected()==true && strings[0]!="0"&&strings[1]!="0") {
         ...
         homeMain.showresponse("Please Check Your Internet Connection Or GPS");
     }
     return sb.toString();
    }
    ...
    protected void onPostExecute(String result) {
        ...
        // homeMain.showresponse(current_location_latitude+","+current_location_longitude);
        if(Error_Message!=""){
homeMain.showresponse(Error_Message);
    ...
    public  boolean isconnected(){
        ConnectivityManager conMgr = (ConnectivityManager)homeMain.getSystemService(Context.CONNECTIVITY_SERVICE);
