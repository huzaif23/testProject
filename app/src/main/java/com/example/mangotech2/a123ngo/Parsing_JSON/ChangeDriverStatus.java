...
public class ChangeDriverStatus extends AsyncTask<String, Void, String> {
    DriverHome driverHome;
    String Error_Message="";
   static String driver_details_id,driver_status;
    public ChangeDriverStatus(DriverHome driverHome){
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            URL url = new URL(DocumentEnums.ApiUrl+"/api/Driver/ChangeDriverStatus");
            driver_details_id=strings[0];
            driver_status=strings[1];
            JSONObject postDataParams = new JSONObject();
            postDataParams.put("driver_details_id",Integer.parseInt( driver_details_id));
            postDataParams.put("driver_status", Integer.parseInt(driver_status));
