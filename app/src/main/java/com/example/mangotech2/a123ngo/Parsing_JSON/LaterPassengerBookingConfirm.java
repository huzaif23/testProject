...
import com.example.mangotech2.a123ngo.RideLater;
...
public class LaterPassengerBookingConfirm extends AsyncTask<String, Void, String> {
    String Error_Message="";
    RideLater rideLater;
    public LaterPassengerBookingConfirm(RideLater rideLater){
    ...
    protected void onPostExecute(String result) {
        ...
        //     rideLater.showresponse(result+" ");
        if (Error_Message != "") {
            rideLater.showresponse(Error_Message);
            Error_Message = "";
        } else {
